...
def train_one_epoch(sess, ops, summary_ops, file_writers, pcreader):
    ...
    for batch_idx in range(pcreader._num_train_samples):
        ...
        np.savez(f'/contact_graspnet/batch_data/batch_data_{scene_idx}_{batch_idx}.npz', batch_data=batch_data, cam_poses=cam_poses)
        print(f'batch_data_{scene_idx}_{batch_idx}.npz saved')
